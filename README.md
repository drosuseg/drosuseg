...
|---|---|---|
| 🌪️ **Smartbash** | Multilingual (EN/Bisaya/Tagalog) disaster-reporting system — fine-tuned XLM-RoBERTa classifier (98.32% F1), CLIP photo validation, DBSCAN clustering, A* routing | Next.js/React, Django, PostgreSQL/PostGIS |
| 🧠 **EchoMind** | AI-powered mental health journaling app — NLP-based sentiment/emotion analysis | React.js, CSS, Python, MySQL |
| 🎓 **UniJam** | Full-stack SaaS for event registration, attendance, feedback & analytics — built solo, end-to-end | React.js, REST, MySQL |
| 🗳️ **Election Voting System** | Secure voting platform — auth, ballot submission, validation, automated tabulation, admin dashboards | ASP.NET Core, C#, MS SQL Server |
| 🕒 **Employee Attendance Monitoring** | Time-in/out tracking, CRUD ops, automated reporting dashboards | ASP.NET Core, C#, MS SQL Server |
